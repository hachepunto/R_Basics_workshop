...
# TASK 2 and ii) captures all the 1000 vectors produced (each vector 
...
## TASK 4 ##
# The loop you wrote in TASK 3 simulated 1000 iterations of the temporal 
...
## TASK 5 ##
# Modify the function "my.second.ricker.fun" (see TASK 1) to incorporate 
